...
func main() {
	setupMode := flag.Bool("setup", false, "install PKGuard with best-practices config and configure Maven")
	uninstallMode := flag.Bool("uninstall", false, "remove PKGuard and restore Maven settings")
