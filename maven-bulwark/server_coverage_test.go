...
// ─── Explicit logging level behavior tests (maven) ───────────────────────────

func TestLoggingLevelDebugBehaviorMaven(t *testing.T) {
...
func TestLoggingLevelInfoBehaviorMaven(t *testing.T) {
...
func TestLoggingLevelWarnBehaviorMaven(t *testing.T) {
...
func TestLoggingLevelErrorBehaviorMaven(t *testing.T) {
...
func TestLoggingJSONFormatBehaviorMaven(t *testing.T) {
...
func TestLoggingFileOutputMaven(t *testing.T) {
...
func TestDynamicLogLevelAPIMaven(t *testing.T) {
	mock := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
	defer mock.Close()
...
func TestParseLogLevelMaven(t *testing.T) {
	tests := []struct {
		input string
		want  slog.Level
		ok    bool
...
func TestLoggingEnvOverrideMaven(t *testing.T) {
	yaml := `
upstream:
  url: "https://repo1.maven.org/maven2"
server:
