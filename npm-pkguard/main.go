...
func main() {
	setupMode := flag.Bool("setup", false, "install PKGuard with best-practices config and configure npm")
	uninstallMode := flag.Bool("uninstall", false, "remove PKGuard and restore npm registry")
