...
curl -LO https://github.com/<owner>/PKGuard/releases/latest/download/npm-pkguard-linux-amd64
curl -LO https://github.com/<owner>/PKGuard/releases/latest/download/npm-pkguard-config-best-practices.yaml
